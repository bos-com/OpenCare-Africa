"""
Base settings for opencare-africa project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='opencare_africa'),
        'USER': config('DB_USER', default='opencare_user'),
        'PASSWORD': config('DB_PASSWORD', default='opencare_password'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'OpenCare-Africa API',
    'DESCRIPTION': 'Health Informatics Platform API for Africa',
    'VERSION': '1.0.0',
